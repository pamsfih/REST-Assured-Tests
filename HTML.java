...
public class HTML {
	...
	public void deveFazerBuscasComHTML() {
		...
		.then()
			...
			.body("html.body.div.table.tbody.tr.size()", is(3)) // conta o número de elementos na tabela
	...
	public void deveFazerBuscasComXpathEmHTML() {
		...
		given()
			.log().all()
		.when()
			.get("https://restapi.wcaquino.me/v2/users?format=clean") // a tabela crua sem estilo
		.then()
			.log().all()
			.statusCode(200)
			.contentType(ContentType.HTML)
